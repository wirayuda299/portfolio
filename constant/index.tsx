...
function PencilLight() {
	return (
		<svg xmlns='http://www.w3.org/2000/svg' width='25' height='24' fill='none'>
			<g clipPath='url(#A)'>
				<path
					d='M22.749 2H2.441a1.86 1.86 0 0 0-1.305.533c-.346.341-.541.803-.541 1.286v16.364c0 .482.195.945.541 1.286A1.86 1.86 0 0 0 2.441 22h20.308a1.86 1.86 0 0 0 1.305-.532c.346-.341.541-.803.541-1.286V3.818c0-.482-.194-.945-.541-1.286A1.86 1.86 0 0 0 22.749 2zM8.534 14c.196.145.325.36.36.599a.9.9 0 0 1-.175.674c-.147.193-.366.32-.608.354s-.489-.028-.684-.173l-3.692-2.727c-.115-.085-.208-.194-.272-.321a.9.9 0 0 1 0-.813c.064-.126.157-.236.272-.321l3.692-2.727c.196-.145.442-.207.684-.173s.461.162.608.355a.9.9 0 0 1 .175.674c-.035.239-.164.454-.36.599l-2.708 2 2.708 2zm6.795-8.114l-3.692 12.727c-.031.117-.086.226-.161.322a.92.92 0 0 1-.275.235c-.107.06-.224.098-.346.112a.94.94 0 0 1-.363-.029.93.93 0 0 1-.324-.165.91.91 0 0 1-.234-.276.9.9 0 0 1-.107-.343c-.012-.12 0-.242.036-.357l3.692-12.727a.91.91 0 0 1 .442-.532c.212-.114.462-.14.694-.075a.92.92 0 0 1 .549.425c.119.207.152.452.089.682zm6.128 6.841l-3.692 2.727c-.196.145-.442.207-.684.173s-.461-.162-.608-.354a.9.9 0 0 1-.175-.674c.035-.239.164-.454.36-.599l2.708-2-2.708-2c-.097-.072-.179-.161-.241-.264a.9.9 0 0 1-.119-.335c-.017-.118-.011-.239.02-.354s.083-.224.156-.32a.92.92 0 0 1 .268-.237c.104-.061.22-.101.34-.118s.242-.01.36.019a.93.93 0 0 1 .325.153l3.692 2.727c.115.085.208.194.272.321a.9.9 0 0 1 0 .813c-.064.126-.157.236-.272.321z'
					fill='#0252cd'
				/>
			</g>
			<defs>
				<clipPath id='A'>
					<path fill='#0252cd' transform='translate(.595)' d='M0 0h24v24H0z' />
				</clipPath>
			</defs>
		</svg>
	);
...
function Code() {
	return (
		<svg xmlns='http://www.w3.org/2000/svg' width='25' height='24' fill='none'>
			<path
				d='M3.5 17.25V21h3.75L18.31 9.93l-3.75-3.75L3.5 17.25zm19.61 1.11l-4.25 4.25-5.2-5.2 1.77-1.77 1 1 2.47-2.48 1.42 1.42L18.86 17l1.06 1 1.42-1.4 1.77 1.76zm-16-7.53L1.89 5.64l4.25-4.25L7.9 3.16 5.43 5.64 6.5 6.7l2.46-2.48 1.42 1.42-1.42 1.41 1 1-2.85 2.78zM21.21 7c.39-.39.39-1 0-1.41l-2.34-2.3c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75L21.21 7z'
				fill='#0252cd'
			/>
		</svg>
	);
