export default function Card() {
	return (
		<div className='justify-center-center sm1:p-24 flex aspect-square max-h-[500px] w-full flex-col rounded-lg bg-black p-12 text-white dark:bg-white dark:text-black md:h-full md:p-16 lg:p-24'>
