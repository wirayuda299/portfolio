	...
	return (
		<div className='h-full w-full  '>
			<div className='flex h-full w-full flex-col justify-center md:max-w-lg'>
				...
				<h2 className='relative z-0 w-fit py-[14px] text-3xl font-bold text-black-200 dark:text-white sm:text-5xl lg:text-[64px]'>
					Professional{' '}
					<div className='whitespace-nowrap py-3 after:absolute after:bottom-[53px] after:left-0 after:z-[-1] after:h-5 after:w-full after:bg-secondary sm:after:bottom-16 lg:after:bottom-[84px]'>
						Web Developer
					</div>{' '}
					based in Bali
				</h2>
