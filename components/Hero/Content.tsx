...
export default function Content() {
	return (
		<div className='flex h-full w-full flex-col justify-center lg:max-w-500'>
			<h1 className='animate-fade-up pb-5 text-sm uppercase text-primary-light md:pb-7 md:text-xl'>
				Hi, I am Wirayuda
			</h1>
			<h2 className='z-0 w-fit animate-fade-up text-3xl font-bold text-black-200  dark:text-white sm:text-5xl  xl:text-16'>
				Professional{' '}
				...
				based in Bali
				<Image
					className='animate-delay-300 animate-duration-1000 inline-block h-12 w-12 animate-fade-right object-contain lg:h-14 lg:w-14'
