...
export default function Content() {
	return (
		<div className='flex h-full w-full flex-col justify-center lg:max-w-[500px]'>
			...
			<h2 className='z-0 w-fit animate-fade-up py-[14px] text-3xl font-bold text-black-200  animate-once dark:text-white sm:text-5xl xl:text-[64px]'>
				Professional{' '}
			...
			<p className='animate-fade-up text-xs text-white-500  animate-once dark:text-white sm:text-sm'>
