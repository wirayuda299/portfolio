export default function Card() {
	return (
		<div className='justify-center-center flex aspect-square max-h-500 w-full flex-col rounded-lg bg-black p-11 text-white dark:bg-white dark:text-black sm1:p-24 md:h-full md:p-16 lg:p-24'>
